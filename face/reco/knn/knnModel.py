...
"""
def calculDistance(firstElement, secondElement,metric):#firstelElement est la liste de features du premier element et same for secondElement
    distance = 0
    if metric == 'manhattan':
        ...
        for value1, value2 in zip(firstElement,secondElement):
            distance+=(value1-value2)**2 #metrique euclidienne
...
def knn(classeInconnue,features,labels,k): #on considere que classeInconnue et les colonnes du dataset sont les memes tailles
    ...
    for feature in features:
        distance = calculDistance(classeInconnue,feature,metric = "manhattan")
